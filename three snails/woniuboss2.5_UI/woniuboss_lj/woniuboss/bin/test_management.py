...
# 咨询部数据
test_add_resource_info = Utility.get_excel_to_tuple(data_config_info[7])

test_edit_resource_info=Utility.get_excel_to_tuple(data_config_info[8])
test_set_info=Utility.get_excel_to_tuple(data_config_info[9])
test_add_role_info=Utility.get_excel_to_tuple(data_config_info[10])
test_edit_role_info=Utility.get_excel_to_tuple(data_config_info[11])
test_query_username_info=Utility.get_excel_to_tuple(data_config_info[12])
test_user_set_info=Utility.get_excel_to_tuple(data_config_info[13])
test_dict_add_info=Utility.get_excel_to_tuple(data_config_info[14])
test_details_edit_info=Utility.get_excel_to_tuple(data_config_info[15])
class TestManagement(unittest.TestCase):
    ...
    #     if Service.is_element_present(self.driver, By.CSS_SELECTOR, '#res_tree_22_span'):
    ...
    #     if Service.is_element_present(self.driver, By.CSS_SELECTOR, '#user-table > tbody:nth-child(2) > tr:nth-child(1) > td:nth-child(7) > button:nth-child(1)') or Service.is_element_present(self.driver, By.CSS_SELECTOR, '.no-records-found > td:nth-child(1)'):
