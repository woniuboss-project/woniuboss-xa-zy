...
class Enterprise:
    ...
    def input_employee_name(self,employee):
        emoloyeename = self.driver.find_element_by_xpath('/html/body/div[7]/div[2]/div/input')
        Service.send_input(emoloyeename,employee)

    #点击搜索按钮
    def click_search(self):
        self.driver.find_element_by_xpath('/html/body/div[7]/div[2]/div/button[2]').click()
