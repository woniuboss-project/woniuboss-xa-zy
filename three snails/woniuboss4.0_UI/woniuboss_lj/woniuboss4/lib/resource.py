...
# from test_WoniuBoss4_0.unit.utility import *
# from test_WoniuBoss4_0.common.login import Login
...
# class Training_Resources:
    ...
    def tranin(self):
    #点击资源管理，进入资源管理界面
        self.driver.find_element_by_xpath('/html/body/div[4]/div[2]/div[4]/div[1]/a').click()
    #点击资源管理内的培训资源
        self.driver.find_element_by_xpath('/html/body/div[4]/div[2]/div[4]/div[2]/div/ul/li[1]/a').click()
        # #点击解密按钮
    ...
    #选择资源库的下拉框
    def resource_store(self): # 资源库下拉框
    ...
    def select_status(self):
        state = self.driver.find_element_by_css_selector('div.col-lg-12:nth-child(1) > select:nth-child(2)')
    ...
    def select_search(self):
        # #点击搜索按钮
        seek = self.driver.find_element_by_css_selector('button.btn:nth-child(7)').click()
    ...
    #点击废弃
    def out_student_msg(self):
        self.driver.refresh()
        time.sleep(2)
        self.driver.find_element_by_css_selector('th.bs-checkbox > div:nth-child(1) > input:nth-child(1)').click()
        self.driver.find_element_by_css_selector('#abandon').click()
